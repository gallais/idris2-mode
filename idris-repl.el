...
(defun idris-contrast-ratio-against-black (color-name)
  ...
  (/ (+ 0.05 (idris-luminance (color-name-to-rgb color-name)))
...
(defun idris-repl-get-logo ()
  ...
  (let* ((logo-path-light (concat idris-mode-path "logo-small.png"))
          (logo-path-dark  (concat idris-mode-path "logo-small-dark-contrast.png"))
          (logo-path       (if (< (idris-contrast-ratio-against-black
                                   (idris-get-bg-color))
                                  6.0)
                               logo-path-dark
                             logo-path-light)))
